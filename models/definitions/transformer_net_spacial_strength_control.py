...
class TransformerNet(torch.nn.Module):
    def __init__(self):
        ...
        kernel_sizes = [9, 3, 3]
        stride_sizes = [1, 2, 2]
        self.conv1 = ConvLayer(num_of_channels[0] + 1, num_of_channels[1], kernel_size=kernel_sizes[0], stride=stride_sizes[0])
    ...
    def forward(self, x, style_strength):
        ...
        y = self.res1(y, style_strength)
        y = self.res2(y, style_strength)
        y = self.res3(y, style_strength)
        y = self.res4(y, style_strength)
        y = self.res5(y, style_strength)
