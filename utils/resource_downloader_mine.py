...
MS_COCO_2017_TRAIN_DATASET_PATH = r'http://images.cocodataset.org/zips/train2017.zip'  # 25 GB after unzipping
...
DOWNLOAD_DICT = {
    ...
    'mscoco_dataset': MS_COCO_2017_TRAIN_DATASET_PATH,
}
...
if __name__ == '__main__':
    ...
    print('Downloading to : ', resource_tmp_path)
    download_url_to_file(remote_resource_path, resource_tmp_path)
    print('Downloaded : ', resource_tmp_path)
